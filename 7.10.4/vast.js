jwplayer.vast = {},
    function(a) {
        ...
        a.vast.schedule = function() {
            ...
            this.setPreRoll = function(a) {
            ...
            }, this.sortVmap = function(a) {
                this.sort(a);
                for (var b = this.getAllAds(), c = 0; c < b.length; c++) b[c]._vmap.item = c + 1
                ...
                var a = e ? [e] : [],
                    b = g ? [g] : [];
                return a.concat(h, b)
            }, this.getAdScheduleEventObject = function() {
                for (var a = this.getAllAds(), b = [], c = {
                        tag: this.getVMAP(),
                        client: "vast",
                        adbreaks: []
                    }, d = 0; d < a.length; d++) {
        ...
        a.vast.vmapparser = function(a, f) {
            for (var i = b(a, "AdBreak", h), j = 0; j < i.length; j++) {
                var k = {},
                    ...
                    r = c(q, "id"),
                    s = b(m, "AdTagURI", h)[0],
                    t = b(m, "VASTData", h)[0] || b(m, "VASTAdData", h)[0],
                    u = c(s, "templateType"),
                    v = d(s),
                    w = b(m, "Tracking", h);
                if (k._type = p, k._vmap = {
                        id: r,
                        breakid: o,
                        timeoffset: n
                    }, t) k._adXML = b(t, "VAST")[0];
                else {
                    if ("vast1" != u && "vast2" != u && "vast3" != u) continue;
                    k._adQueue = [v], k._waterfallIndex = 0
                }
                if (w)
                    for (var x = 0; x < w.length; x++) e(l, w[x]);
                switch (k._trackers = l, k._type = p, n) {
                    case "start":
    ...
    function(a) {
        ...
        d.vast.adplayer = function(j, k, l, m, n, o) {
            ...
            function A() {
                var a = sa._adQueue || {},
                    b = {
                        ...
                        wcount: a.length || 1,
                        viewable: k.getViewable()
                    };
                return oa && oa.length && (b.sequence = xa + 1, b.podcount = oa.length), na && (b.creativetype = na), sa._vmap && (b.vmap = sa._vmap), b
            }
            ...
            function D(a) {
                ...
                ma && ma.applyProviderListeners(ka), ka.blocking = ma, ka.onPlay(Q), ka.onPause(S), ka.onQuartile(U), ka.onRemainingTimeChange(T), ka.onClick(ca), ka.onError(ga), ka.onImpression(P), ka.onExpandedChange(ia), ka.onClose(Y), ka.onSkipped(fa), ka.onStopped($), ka.onComplete(X), ka.onStarted(Z)
            }
            ...
            function G(a) {
                ...
                if (e = d.playlist.item(e), "instream" === c && (e.sources = F(e.sources)), 0 === e.sources.length) return null;
            ...
            function ca(a) {
                var b = I(xa);
                a && a.url && a.playerHandles && (b.clickthrough = a.url), ea(b)
            }
    ...
    function(a) {
        ...
        c.adcontroller = function(a, h, i) {
            function j(b) {
                if (b) {
                    ...
                    var f = function(d) {
                            ba = null;
                            try {
                                c.vmapparser(d.responseXML, V), a.dispatchEvent("adSchedule", V.getAdScheduleEventObject())
                            } catch (f) {
                                return void S({
                                    id: g,
            ...
            function D(b) {
                ...
                return d.on(e.COMPLETE, G), d.on(e.ERROR, R), d.on("adPodError", Q), ha.push(d), X && !X.started && X.breakStart(), d
            }
            ...
            function H(b) {
                ...
                var g = f.init(ga);
                return g ? (na = ga, ga = null, $.off("blockingStarted"), $.off(e.state.PLAYING, v), na && na.on("adBreakEnd", function() {
                    X && X.breakEnd()
                }), f.on(e.JWPLAYER_AD_COMPLETE, N), void ia.push(f)) : void f.destroy()
            }
            ...
            function M(b) {
                ka = {}, a.dispatchEvent(e.JWPLAYER_AD_IMPRESSION, b)
            }

            function N() {
                0 === ha.length && "post" === ca && a.attachMedia()
            }
            ...
            function P() {
                if (ga) {
                    var a = ga;
                    ga = null, a.destroy(), $.off("blockingStarted"), $.off(e.state.PLAYING, v)
                }
                na = null
            }
